...
/** Outline heart for wishlist/saved (placeholder). */
...
/** Filled heart for favorite state (use text-[var(--primary)] or similar). */
...
/** User/profile icon for bottom nav. */
...
/** Sliders/filter icon for results pill row. */
...
/** Coffee/breakfast icon for room amenities. */
...
/** Bed icon for room amenities / sleeps. */
...
/** Info icon for tooltips and (i) explanations. */
...
/** Share icon for header / native share. */
...
/** Chevron up for expand/collapse. */
...
/** Hotel / lodging for place autocomplete (types: hotel, lodging). */
export function HotelPlaceIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 22h20" />
...
/** Locality / city for place autocomplete (locality, administrative_area, etc.). */
export function LocalityIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
